    ...
    for bin_width in ep.selected_bin_widths:
        ...
        for mouse_name in  ep.mouse_names:
            ...
            if reject_dict['signal_inds'].size == 0:
                ...
                plt.savefig(os.path.join(image_dir, 'community_detection', 'eigenspectrum_histograms', args.correlation_type, args.correction, mouse_name + '_' + str(bin_width).replace('.','p') + '_' + args.correction + '_eig_hist.png'))
                plt.close()
