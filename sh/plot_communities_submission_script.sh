...
time python3 $HOME/Eight_Probe/py/plot_communities.py -r signal -c rectified # fail
...
time python3 $HOME/Eight_Probe/py/plot_communities.py -r signal -c negative # fail
echo `date +'%d-%m-%Y %T'`" INFO: Completed signal negative."
time python3 $HOME/Eight_Probe/py/plot_communities.py -r total -c absolute # fail
echo `date +'%d-%m-%Y %T'`" INFO: Completed total absolute."
time python3 $HOME/Eight_Probe/py/plot_communities.py -r conditional -c absolute # fail
echo `date +'%d-%m-%Y %T'`" INFO: Completed conditional absolute."
time python3 $HOME/Eight_Probe/py/plot_communities.py -r signal -c absolute # fail
