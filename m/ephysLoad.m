ephysroot = '/space/td16954/Eight_Probe/mat';
% mouse names
...
addpath(genpath('/home/pgrads/td16954/linux/Matlab/allenCCF'));
addpath(genpath('/home/pgrads/td16954/linux/Matlab/npy-matlab'));
plotBrainGrid([], [], [], 0);
hold all;
